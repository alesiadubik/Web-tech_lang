...
farengateFromCelsius(temperature);

function farengateFromCelsius(celsius) {
    
    const farengate =Math.round((celsius*(9/5)+32)*10)/10
    alert(`Цельсий: ${celsius}, Фаренгейт: ${farengate}`);
}